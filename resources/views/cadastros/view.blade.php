            ...
            <div class="form-buttons mt-2 mb-3 d-flex justify-content-between">
                ...
                @can('super-admin')
                    @if ($beneficiaria->status === 2)
                        <div>
                            <button class="btn btn-danger btn-lg" type="button" id="deny-submit"
                                style="margin-right: 5px">Negar</button>
                            <button class="btn btn-success btn-lg" type="button" id="approve-submit">Aprovar</button>
                        </div>
                    @endif
                @endcan
            </div>
